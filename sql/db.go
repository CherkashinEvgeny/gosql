...
func (d *baseDb) propagation(options []internal.Option) (factory func(ctx context.Context, tx internal.Tx, options internal.Options) (newTx internal.Tx, err error)) {
